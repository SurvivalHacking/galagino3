...
Video::Video() {
  // Empty - hardware init moved to begin() to avoid crash during global construction
}

void Video::begin(void) {
  // Hardware init (moved from constructor to avoid crash during global init)
